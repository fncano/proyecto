class VentasController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @venta.update(venta_params)
        format.html { redirect_to ventas_path, notice: 'Se ha Modificado un Registro.' }
  ...
  def destroy
    @venta.destroy
    respond_to do |format|
      format.html { redirect_to ventas_url, notice: 'Se ha Borrado un Registro.' }
  ...
  private
    ...
    def venta_params
      params.require(:venta).permit(:fecha, :num_fact, :cliente, :fecha_entrega, :empleado, :cant, :prenda, :pieza, :talla, :val_uni, :total, :subtotal, :iva, :total)
    end
end
